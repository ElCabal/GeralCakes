...
const DetailProduct = () => {
  ...
  function knowValuePortion(valueOption) {
  ...
  return (
    <div className="pt-32 pb-10 px-10 bg-pink-100 flex flex-col gap-4 md:flex-row-1 ">
      <div className="">
        <h2 className="text-3xl font-semibold ">{result[0].name}</h2>
        ...
        <div>
          ...
          <select
            onChange={(valueSelect) => {
              knowValuePortion(valueSelect.target.value);
            }}
